...
/**
 * Loop that listens to user speech while sending userText to respond endpoint
 * @param {string} text - what Twilio will speak 
 * @param {string} actionPath - where Twilio POSTs when the user finishes speaking
 * @returns {Promise<string>} the text message sent to /voice/respond
 */
//GATHER logic generated by AI
